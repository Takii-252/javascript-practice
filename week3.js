...
//*学習53 コールバック関数を直接定義する
// 事前に定義した関数をコールバック関数として渡しましたが、関数を直接引数の中で定義することも可能
call(() => {
  console.log("こんにちは");
});
// 上の書き方はややこしいが要は
//call(3,7);とやっていることは変わらない。このように書くとcallの引数であるcallbackに値が定義されるが
//上のようにテキストを直接定義することが出来るよということ
...
//コールバック関数から引数を二つ受け取る関数を定義する（name,age）
call1((name, age) => {
